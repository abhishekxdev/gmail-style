...
>(({ className, ...rest }, forwardedRef) => {
  return (
    <th
      ref={forwardedRef}
      className={cn(
        'bg-muted/50 px-3 py-2 text-left text-xs font-medium text-muted-foreground first:rounded-l-lg last:rounded-r-lg',
        className,
      )}
      {...rest}
    />
...
>(({ className, ...rest }, forwardedRef) => {
  return (
    <td
      ref={forwardedRef}
      className={cn(
        'h-16 px-3 transition duration-200 ease-out first:rounded-l-xl last:rounded-r-xl group-hover/row:bg-muted/50',
        className,
      )}
      {...rest}
    />
